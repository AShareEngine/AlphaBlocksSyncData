# Tushare Pro 数据接口完整文档

- 来源：[Tushare 数据接口](https://tushare.pro/document/2)
- 导出时间：2026-07-31 15:44:30 CST
- 文档页面：273 个（其中末级数据项 241 个）
- 说明：本文档由公开网页自动整理；接口权限、积分要求和字段定义可能更新，关键使用场景请以各节所附原始页面为准。
...
- [ETF专题](#doc-384)
  ...
  - [ETF复权因子](#doc-199)
  - [ETF份额规模](#doc-408)
  - [每日篮子组合(沪市PCF）](#doc-471)
  - [每日篮子组合(深市PCF）](#doc-472)
  - [ETF实时参考](#doc-454)
  - [指数公司公告](#doc-460)
- [指数专题](#doc-93)
  - [指数基本信息](#doc-94)
...
- [宏观经济](#doc-147)
  - [国内宏观](#doc-224)
    ...
    - [国民经济](#doc-225)
      - [国内生产总值（GDP）](#doc-227)
    - [价格指数](#doc-226)
      - [居民消费价格指数（CPI）](#doc-228)
      - [工业生产者出厂价格指数（PPI）](#doc-245)
    - [金融](#doc-240)
      - [货币供应量](#doc-241)
        - [货币供应量（月）](#doc-242)
      - [社会融资](#doc-309)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=14)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=24)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=25)
...
| 名称 | 类型 | 必选 | 描述 |
| --- | --- | --- | --- |
| ts_code | str | N | TS股票代码([格式说明](#doc-14)) |
| name | str | N | 名称 |
...
说明：旧版上的PE/PB/股本等字段，请在行情接口[“每日指标”](#doc-32)中获取。
...
[查看原始页面](https://tushare.pro/document/2?doc_id=329)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=26)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=397)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=423)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=398)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=100)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=112)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=193)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=194)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=375)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=123)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=262)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=15)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=27)
...
接口：daily，可以通过[**数据工具**](https://tushare.pro/webclient/)调试和查看数据
 ...
 描述：获取股票行情数据，或通过[**通用行情接口**](#doc-109)获取数据，包含了前后复权数据
...
[查看原始页面](https://tushare.pro/document/2?doc_id=372)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=370)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=374)
...
## 股票数据 / 行情数据 / A股实时分钟-日累计

[查看原始页面](https://tushare.pro/document/2?doc_id=457)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=144)
...
接口：weekly
描述：获取A股周线行情，本接口每周最后一个交易日更新，如需要使用每天更新的周线数据，请使用[日度更新的周线行情接口](#doc-336)。
...
| change | float | Y | 周涨跌额 |
| pct_chg | float | Y | 周涨跌 （未复权，未*100，如果是复权请用 [通用行情接口](#doc-109)，如需%单位请*100 ） |
| vol | float | Y | 周成交量 |
| amount | float | Y | 周成交额 |
...
[查看原始页面](https://tushare.pro/document/2?doc_id=145)
...
| change | float | Y | 月涨跌额 |
| pct_chg | float | Y | 月涨跌幅 （未复权，如果是复权请用 [通用行情接口](#doc-109) ） |
| vol | float | Y | 月成交量 |
| amount | float | Y | 月成交额 |
...
[查看原始页面](https://tushare.pro/document/2?doc_id=146)
...
**接口名称** ：pro_bar
 **接口说明** ：复权行情通过[通用行情接口](#doc-109)实现，利用Tushare Pro提供的[复权因子](#doc-28)进行动态计算，因此http方式无法调取。若需要静态复权行情（支持http），请访问[股票技术因子接口](#doc-328)。
...
## 股票数据 / 行情数据 / 周/月线行情(每日更新)

[查看原始页面](https://tushare.pro/document/2?doc_id=336)
...
## 股票数据 / 行情数据 / 周/月线复权行情(每日更新)

[查看原始页面](https://tushare.pro/document/2?doc_id=365)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=28)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=32)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=109)
...
股票Daily：[https://tushare.pro/document/2?doc_id=27](#doc-27)

基金Daily：[https://tushare.pro/document/2?doc_id=127](#doc-127)

期货Daily：[https://tushare.pro/document/2?doc_id=138](#doc-138)

期权Daily：[https://tushare.pro/document/2?doc_id=159](#doc-159)

指数Daily：[https://tushare.pro/document/2?doc_id=95](#doc-95)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=183)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=214)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=48)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=49)
...
| name | str | Y | 股票名称 |
| close | float | Y | 收盘价 |
| p_change | float | Y | 涨跌幅 |
| rank | int | Y | 资金排名 |
| market_type | str | Y | 市场类型 2：港股通（沪） 4：港股通（深） |
| amount | float | Y | 累计成交金额（元） |
| net_amount | float | Y | 净买入金额（元） |
| sh_amount | float | Y | 沪市成交金额（元） |
| sh_net_amount | float | Y | 沪市净买入金额（元） |
| sh_buy | float | Y | 沪市买入金额（元） |
| sh_sell | float | Y | Y |
| sz_amount | float | Y | 深市成交金额（元） |
| sz_net_amount | float | Y | 深市净买入金额（元） |
| sz_buy | float | Y | 深市买入金额（元） |
| sz_sell | float | Y | 深市卖出金额（元） |
...
[查看原始页面](https://tushare.pro/document/2?doc_id=196)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=255)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=16)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=33)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=36)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=44)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=45)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=46)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=103)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=79)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=80)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=81)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=162)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=17)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=451)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=452)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=453)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=61)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=62)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=110)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=111)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=124)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=160)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=161)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=164)
...
数据说明：从2017年2月10日开始，中国证券登记结算公司停止了发布本周持仓账户数和本周交易账户数；另外，2015年5月8日之前的数据结构也不同，具体请参阅[股票开户旧数据](#doc-165)接口。
...
[查看原始页面](https://tushare.pro/document/2?doc_id=165)
...
接口：stk_account_old
描述：获取股票账户开户数据旧版格式数据，数据从2008年1月开始，到2015年5月29，新数据请通过[股票开户数据](#doc-164)获取。
积分：600积分可调取，具体请参阅[积分获取办法](https://tushare.pro/document/1?doc_id=13)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=166)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=175)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=291)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=292)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=293)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=294)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=296)
...
## 股票数据 / 特色数据 / 股票技术面因子(专业版）

[查看原始页面](https://tushare.pro/document/2?doc_id=328)
...
## 股票数据 / 特色数据 / 中央结算系统持股统计

[查看原始页面](https://tushare.pro/document/2?doc_id=295)
...
## 股票数据 / 特色数据 / 中央结算系统持股明细

[查看原始页面](https://tushare.pro/document/2?doc_id=274)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=188)
...
## 股票数据 / 特色数据 / 股票开盘集合竞价数据

[查看原始页面](https://tushare.pro/document/2?doc_id=353)
...
## 股票数据 / 特色数据 / 股票收盘集合竞价数据

[查看原始页面](https://tushare.pro/document/2?doc_id=354)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=364)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=399)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=275)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=267)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=330)
...
## 股票数据 / 两融及转融通 / 融资融券交易汇总

[查看原始页面](https://tushare.pro/document/2?doc_id=58)
...
## 股票数据 / 两融及转融通 / 融资融券交易明细

[查看原始页面](https://tushare.pro/document/2?doc_id=59)
...
## 股票数据 / 两融及转融通 / 融资融券标的（盘前）

[查看原始页面](https://tushare.pro/document/2?doc_id=326)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=332)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=331)
...
## 股票数据 / 两融及转融通 / 转融券交易明细(停）

[查看原始页面](https://tushare.pro/document/2?doc_id=333)
...
## 股票数据 / 两融及转融通 / 做市借券交易汇总(停）

[查看原始页面](https://tushare.pro/document/2?doc_id=334)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=342)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=170)
...
注：净流入为主动买卖单的净值，基于L2订单计算，此处不能简单把大小单总和相减。
...
## 股票数据 / 资金流向数据 / 个股资金流向（THS）

[查看原始页面](https://tushare.pro/document/2?doc_id=348)
...
## 股票数据 / 资金流向数据 / 个股资金流向（DC）

[查看原始页面](https://tushare.pro/document/2?doc_id=349)
...
## 股票数据 / 资金流向数据 / 板块资金流向（THS)

[查看原始页面](https://tushare.pro/document/2?doc_id=371)
...
## 股票数据 / 资金流向数据 / 行业资金流向（THS）

[查看原始页面](https://tushare.pro/document/2?doc_id=343)
...
## 股票数据 / 资金流向数据 / 板块资金流向（DC）

[查看原始页面](https://tushare.pro/document/2?doc_id=344)
...
## 股票数据 / 资金流向数据 / 大盘资金流向（DC）

[查看原始页面](https://tushare.pro/document/2?doc_id=345)
...
## 股票数据 / 资金流向数据 / 沪深港通资金流向

[查看原始页面](https://tushare.pro/document/2?doc_id=47)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=346)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=106)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=107)
...
## 股票数据 / 打板专题数据 / THS涨跌停榜单

[查看原始页面](https://tushare.pro/document/2?doc_id=355)
...
## 股票数据 / 打板专题数据 / 涨跌停和炸板数据

[查看原始页面](https://tushare.pro/document/2?doc_id=298)
...
## 股票数据 / 打板专题数据 / 涨停股票连板天梯

[查看原始页面](https://tushare.pro/document/2?doc_id=356)
...
## 股票数据 / 打板专题数据 / 涨停最强板块统计

[查看原始页面](https://tushare.pro/document/2?doc_id=357)
...
## 股票数据 / 打板专题数据 / THS概念板块分类

[查看原始页面](https://tushare.pro/document/2?doc_id=259)
...
## 股票数据 / 打板专题数据 / THS概念板块行情

[查看原始页面](https://tushare.pro/document/2?doc_id=260)
...
## 股票数据 / 打板专题数据 / THS概念板块成分

[查看原始页面](https://tushare.pro/document/2?doc_id=261)
...
## 股票数据 / 打板专题数据 / DC概念板块分类

[查看原始页面](https://tushare.pro/document/2?doc_id=362)
...
## 股票数据 / 打板专题数据 / DC概念板块成分

[查看原始页面](https://tushare.pro/document/2?doc_id=363)
...
## 股票数据 / 打板专题数据 / DC概念板块行情

[查看原始页面](https://tushare.pro/document/2?doc_id=382)
...
## 股票数据 / 打板专题数据 / 开盘竞价成交（当日）

[查看原始页面](https://tushare.pro/document/2?doc_id=369)
...
## 股票数据 / 打板专题数据 / 市场游资最全名录

[查看原始页面](https://tushare.pro/document/2?doc_id=311)
...
## 股票数据 / 打板专题数据 / 游资交易每日明细

[查看原始页面](https://tushare.pro/document/2?doc_id=312)
...
接口：hm_detail
描述：获取每日游资交易明细，数据开始于2022年8。游资分类名录，请点击[游资名录](#doc-311)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=320)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=321)
...
## 股票数据 / 打板专题数据 / TDX概念板块分类

[查看原始页面](https://tushare.pro/document/2?doc_id=376)
...
## 股票数据 / 打板专题数据 / TDX概念板块成分

[查看原始页面](https://tushare.pro/document/2?doc_id=377)
...
## 股票数据 / 打板专题数据 / TDX概念板块行情

[查看原始页面](https://tushare.pro/document/2?doc_id=378)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=347)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=351)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=421)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=422)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=384)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=385)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=386)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=416)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=470)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=387)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=400)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=127)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=199)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=408)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=471)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=472)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=454)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=460)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=93)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=94)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=95)
...
接口：index_daily，可以通过[**数据工具**](https://tushare.pro/webclient/)调试和查看数据。
 描述：获取各类指数每日行情，可通过指数代码和日期循环获取。本接口不包含[申万行业指数行情数据](#doc-327)。
...
| 名称 | 类型 | 必选 | 描述 |
| --- | --- | --- | --- |
| ts_code | str | Y | 指数代码，来源[指数基础信息接口](#doc-94) |
...
[查看原始页面](https://tushare.pro/document/2?doc_id=403)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=420)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=171)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=419)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=172)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=96)
...
| 名称 | 类型 | 必选 | 描述 |
| --- | --- | --- | --- |
| index_code | str | Y | 指数代码，来源[指数基础信息接口](#doc-94) |
| trade_date | str | N | 交易日期（格式YYYYMMDD，下同） |
| start_date | str | N | 开始日期 |
...
[查看原始页面](https://tushare.pro/document/2?doc_id=128)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=181)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=335)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=327)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=417)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=469)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=373)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=308)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=211)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=358)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=215)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=268)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=18)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=19)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=118)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=208)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=462)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=207)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=119)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=120)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=121)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=359)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=134)
...
| --- | --- | --- |
| XX | XXL | XXMMDD |
| 例如：CU.SHF | 例如：CUL.SHF<br>例外：TL0表示30年期国债主力合约，TL表示T合约的主连合约，TLL表示TL合约的主连合约 | 例如：CU1811.SHF |
|  |  |  |
| ![](https://tushare.pro/files/img/ft.png) |  |  |
...
| --- | --- | --- | --- | --- |
| [期货合约列表](#doc-135) | fut_basic | 全部历史 | 2000 | 80 |
| [期货交易日历](https://tushare.pro/document/2?doc_id=137) | trade_cal | 数据开始月1996年1月，定期更新 | 2000 | 200 |
| [期货日线行情](#doc-138) | fut_daily | 数据开始月1996年1月，每日盘后更新 | 2000 | 120 |
| [每日成交持仓排名](#doc-139) | fut_holding | 数据开始月2002年1月，每日盘后更新 | 2000 | 200 |
| [仓单日报](#doc-140) | fut_wsr | 数据开始月2006年1月，每日盘后更新 | 2000 | 200 |
| [结算参数](#doc-141) | fut_settle | 数据开始月2012年1月，每日盘后更新 | 2000 | 200 |
|  |  |  |  |  |
...
[查看原始页面](https://tushare.pro/document/2?doc_id=135)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=467)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=138)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=337)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=313)
...
接口：ft_mins
 描述：获取全市场期货合约分钟数据，支持1min/5min/15min/30min/60min行情，提供Python SDK和 http Restful API两种方式，如果需要主力合约分钟，请先通过主力[mapping](#doc-189)接口（需要有至少2000积分）获取对应的合约代码后提取分钟。
 限量：单次最大8000行数据，可以通过期货合约代码和时间循环获取，本接口可以提供超过10年历史分钟数据。
 权限：需单独开权限，120积分可以调取2次接口查看数据，正式权限请参阅 [权限说明](https://tushare.pro/document/1?doc_id=290)  。
...
[查看原始页面](https://tushare.pro/document/2?doc_id=340)
...
接口：rt_fut_min
描述：获取全市场期货合约实时分钟数据，支持1min/5min/15min/30min/60min行情，提供Python SDK、 http Restful API和websocket三种方式，如果需要主力合约分钟，请先通过主力[mapping](#doc-189)接口获取对应的合约代码后提取分钟。
...
[查看原始页面](https://tushare.pro/document/2?doc_id=140)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=141)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=314)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=139)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=468)
...
接口：fut_index_daily
 描述：获取南华指数每日行情，指数行情也可以通过[**通用行情接口**](#doc-109)获取数据．
...
[查看原始页面](https://tushare.pro/document/2?doc_id=189)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=216)
...
| end_week | str | N | 结束周期 |
| exchange | str | N | 交易所（请参考[交易所说明](#doc-134)） |
...
[查看原始页面](https://tushare.pro/document/2?doc_id=368)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=283)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=284)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=285)
...
| 名称 | 类型 | 必选 | 描述 |
| --- | --- | --- | --- |
| ts_code | str | N | 合约代码，可通过[基础信息](#doc-284)获得 |
| trade_date | str | N | 交易日期 |
| start_date | str | N | 开始日期 |
| end_date | str | N | 结束日期 |
...
[查看原始页面](https://tushare.pro/document/2?doc_id=157)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=158)
...
| exchange | str | N | 交易所代码 （包括上交所SSE等[交易所](#doc-157)） |
...
[查看原始页面](https://tushare.pro/document/2?doc_id=159)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=341)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=184)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=185)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=186)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=269)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=305)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=187)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=459)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=392)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=246)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=247)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=458)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=256)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=322)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=323)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=271)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=272)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=201)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=233)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=177)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=178)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=179)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=190)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=191)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=250)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=192)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=339)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=401)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=304)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=383)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=389)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=390)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=391)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=388)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=251)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=252)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=253)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=254)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=338)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=402)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=394)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=395)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=396)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=393)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=147)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=224)
...
## 宏观经济 / 国内宏观 / 中国经济数据发布日程

[查看原始页面](https://tushare.pro/document/2?doc_id=461)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=148)
...
## 宏观经济 / 国内宏观 / 利率数据 / Shibor利率

[查看原始页面](https://tushare.pro/document/2?doc_id=149)
...
## 宏观经济 / 国内宏观 / 利率数据 / Shibor报价数据

[查看原始页面](https://tushare.pro/document/2?doc_id=150)
...
## 宏观经济 / 国内宏观 / 利率数据 / LPR贷款基础利率

[查看原始页面](https://tushare.pro/document/2?doc_id=151)
...
## 宏观经济 / 国内宏观 / 利率数据 / Libor利率

[查看原始页面](https://tushare.pro/document/2?doc_id=152)
...
## 宏观经济 / 国内宏观 / 利率数据 / Hibor利率

[查看原始页面](https://tushare.pro/document/2?doc_id=153)
...
## 宏观经济 / 国内宏观 / 利率数据 / 温州民间借贷利率

[查看原始页面](https://tushare.pro/document/2?doc_id=173)
...
## 宏观经济 / 国内宏观 / 利率数据 / 广州民间借贷利率

[查看原始页面](https://tushare.pro/document/2?doc_id=174)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=225)
...
## 宏观经济 / 国内宏观 / 国民经济 / 国内生产总值（GDP）

[查看原始页面](https://tushare.pro/document/2?doc_id=227)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=226)
...
## 宏观经济 / 国内宏观 / 价格指数 / 居民消费价格指数（CPI）

[查看原始页面](https://tushare.pro/document/2?doc_id=228)
...
## 宏观经济 / 国内宏观 / 价格指数 / 工业生产者出厂价格指数（PPI）

[查看原始页面](https://tushare.pro/document/2?doc_id=245)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=240)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=241)
...
## 宏观经济 / 国内宏观 / 金融 / 货币供应量 / 货币供应量（月）

[查看原始页面](https://tushare.pro/document/2?doc_id=242)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=309)
...
## 宏观经济 / 国内宏观 / 金融 / 社会融资 / 社融增量（月度）

[查看原始页面](https://tushare.pro/document/2?doc_id=310)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=324)
...
## 宏观经济 / 国内宏观 / 景气度 / 采购经理指数（PMI）

[查看原始页面](https://tushare.pro/document/2?doc_id=325)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=217)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=218)
...
## 宏观经济 / 国际宏观 / 美国利率 / 国债收益率曲线利率

[查看原始页面](https://tushare.pro/document/2?doc_id=219)
...
## 宏观经济 / 国际宏观 / 美国利率 / 国债实际收益率曲线利率

[查看原始页面](https://tushare.pro/document/2?doc_id=220)
...
## 宏观经济 / 国际宏观 / 美国利率 / 短期国债利率

[查看原始页面](https://tushare.pro/document/2?doc_id=221)
...
## 宏观经济 / 国际宏观 / 美国利率 / 国债长期利率

[查看原始页面](https://tushare.pro/document/2?doc_id=222)
...
## 宏观经济 / 国际宏观 / 美国利率 / 国债长期利率平均值

[查看原始页面](https://tushare.pro/document/2?doc_id=223)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=142)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=406)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=415)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=465)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=143)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=195)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=154)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=176)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=366)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=367)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=474)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=446)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=449)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=445)
...
[查看原始页面](https://tushare.pro/document/2?doc_id=447)
