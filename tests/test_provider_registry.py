...
class ProviderRegistryTest(unittest.TestCase):
    def test_builtin_provider_manifests_are_loaded(self) -> None:
        ...
        self.assertIn("income_statement", registry.get("yfinance").task_names)
        self.assertIn("financial_metrics", registry.get("yfinance").task_names)
        self.assertIn("institutional_holders", registry.get("yfinance").task_names)
        ...
        self.assertIn("stock_board_concept_name_ths", registry.get("akshare").task_names)
        self.assertIn("stock_board_concept_index_ths", registry.get("akshare").task_names)
        self.assertIn("stock_board_concept_info_ths", registry.get("akshare").task_names)
    ...
    def test_provider_root_points_to_structured_provider_dir(self) -> None:
        ...
        self.assertTrue((root / "akshare" / "plans" / "full.toml").is_file())
