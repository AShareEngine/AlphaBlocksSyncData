...
from sync_data_system.providers.amazingdata.info import InfoDataSyncProvider
from sync_data_system.providers.amazingdata.market import MarketDataSyncProvider
