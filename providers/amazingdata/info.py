...
from sync_data_system.providers.amazingdata.constants import HISTORY_STOCK_STATUS_FIELDS, STOCK_BASIC_FIELDS, SyncStatus
...
from sync_data_system.providers.amazingdata.info_repository import InfoDataRepository
