...
from sync_data_system.providers.amazingdata.constants import KLINE_FIELDS, SNAPSHOT_FIELDS
...
from sync_data_system.data_models import MarketKlineQuery, MarketKlineRow, MarketSnapshotQuery, MarketSnapshotRow
