...
from sync_data_system.providers.baostock.provider import BaoStockConfig, BaoStockProvider, normalize_baostock_code_list
from sync_data_system.providers.baostock.repository import BaoStockRepository
from sync_data_system.providers.baostock.specs import BAOSTOCK_TASK_CHOICES, BAOSTOCK_TASK_SPECS
...
def build_context(runtime_path: str | None = None, database: str = "baostock") -> BaoStockExecutionContext:
